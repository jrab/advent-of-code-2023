...
const distanceTraveled = (buttonDownTimeMs: number, raceTime: number): number => {
...
const loadRaceData = (list: string): IRaceData[] => {
...
const getTotalWaysToBeatRecord = (raceData: IRaceData[]): number => {
